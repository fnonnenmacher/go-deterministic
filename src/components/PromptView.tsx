        ...
        <div className="font-mono text-base leading-[2.1] whitespace-pre-wrap">
          {segments.map((segment, i) =>
            segment.type === 'text' ? (
              ...
              <span key={i}>
                <span className="rounded-[3px] bg-red-soft px-[3px] py-px underline decoration-red decoration-wavy decoration-[1.5px] underline-offset-4 [box-decoration-break:clone]">
                  {segment.marked}
                </span>
